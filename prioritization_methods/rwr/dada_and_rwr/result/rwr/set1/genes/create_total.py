...
G = nx.read_gpickle("/home/prabal/Desktop/SRM-PPI/prioritization_methods/rwr/dada_and_rwr/HPRD-Biogrid.pkl")
iteration=0
temp_hist_gene=[]
...
for gene in final_hist_gene:
    ...
    count=0
    while iteration<100:
        path = "/home/prabal/Desktop/SRM-PPI/prioritization_methods/rwr/dada_and_rwr/result/rwr/set1/scores/rwr_result_set1_"+str(iteration)+".txt"
        data = pd.read_csv(path,delim_whitespace="",header=None)
        data = data[0]
        x =0
        while x<10:
...
fp =open("/home/prabal/Desktop/SRM-PPI/prioritization_methods/rwr/dada_and_rwr/result/rwr/set1/set1_analysis.txt","w")
