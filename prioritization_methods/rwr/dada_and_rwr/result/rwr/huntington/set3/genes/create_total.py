...
for gene in final_hist_gene:
    ...
    count=0
    while iteration<100:
        path =  "/home/arpit/github/SRM-PPI/prioritization_methods/rwr/dada_and_rwr/result/rwr/set3/scores/rwr_result_set3_"+str(iteration)+".txt"
        data = pd.read_csv(path,delim_whitespace="",header=None)
        data = data[0]
        x =0
        while x<10:
...
fp =open("/home/arpit/github/SRM-PPI/prioritization_methods/rwr/dada_and_rwr/result/rwr/set3/set3_analysis.txt","w")
