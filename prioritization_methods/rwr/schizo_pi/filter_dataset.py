...
seed_list_temp = pd.read_csv("seed_list.txt",delim_whitespace="",header=None)
seed_list_temp=seed_list_temp[0]



candidate_file = open("filtered_candidate_list.txt","w")
seed_file = open("filtered_seed_list.txt","w")
